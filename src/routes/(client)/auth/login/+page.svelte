...
<svelte:head>
	<title>Login - Evolv</title>
</svelte:head>

<div class="w-full h-full flex flex-col items-center justify-center py-20">
	<h3 class="text-3xl text-black font-medium">Login</h3>
	...
	>
		...
		<div class="flex flex-col gap-1">
			...
			{/if}
			<a class="text-end underline text-xs" href="/auth/forgot-password">forgot password?</a>
		</div>
		...
		<div class="grid grid-cols-1 gap-2 w-full items-center">
			...
			<a class="w-full bg-slate-200 px-3 py-2.5 text-center" href="/auth/signup"
				>Create an account</a
			>
		</div>
	</form>
